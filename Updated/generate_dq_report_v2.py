...
def generate_report():
    ...
    # =============================================================
    # SHEET 2: Detailed & New Findings
    # =============================================================
    ws2 = wb.create_sheet(title="Detailed & New Findings")
    ws2.views.sheetView[0].showGridLines = True
    
    # Title Block
    ws2.merge_cells("A2:D2")
    ws2["A2"] = "March 2026 Detailed Findings & Newly Identified Issues"
    ws2["A2"].font = font_title
    ws2["A2"].alignment = align_left
    
    ws2.merge_cells("A3:D3")
    ws2["A3"] = "Detailed Technical Analysis of Data Gaps, Superseded Timestamps, and Database Formatting Anomalies"
    ws2["A3"].font = font_subtitle
    ws2["A3"].alignment = align_left
    
    # -------------------------------------------------------------
    # SECTION A: Detailed Analysis of Gaps & Superseded Timestamps
    # -------------------------------------------------------------
    ws2["A5"] = "II. Detailed Analysis of Data Gaps & Superseded Timestamps (March 2026)"
    ...
    headers_ws2 = [
        ...
        "Detailed Findings & Technical/Operational Impact"
    ]
    ...
    current_row = 7
    for row_data in detailed_findings_data:
        for col_idx, val in enumerate(row_data, 1):
    ...
    wb.save("/home/deveshjha/Downloads/108_KPI_Code/Updated/March_2026_Data_Quality_Report_Updated.xlsx")
